...
def search_smi_in_mol_list(mol_or_smiles, molId_mol_list, n_jobs=1, verbose=False):
    '''
...
if __name__ == "__main__":
    ...
    search_smi_in_mol_list(args.query, molId_mol_list= database_mols, n_jobs = args.n_jobs, verbose=True)

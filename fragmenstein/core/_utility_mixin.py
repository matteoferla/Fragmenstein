...
__doc__ = \
    """
These are extras for the Adam step
    """
...
class _AdamUtil:
    ...
    def get_combined_rmsd(cls, followup_moved: Chem.Mol, followup_placed: Optional[Chem.Mol] = None,
        ...
        :param followup_placed: followup compound as placed by Adam
    ...
    def stdev_from_mol(self, mol: Chem.Mol=None):
        """
        these values are stored from Adam for scaffold, chimera and positioned_mol
    ...
    def mmff_minimise(self, mol: Optional[Chem.Mol]=None) -> None:
        ...
        Gets called by Victor if the flag .adam_mmff_minimisation is true during PDB template construction.

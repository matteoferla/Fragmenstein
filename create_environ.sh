...
pip install rdkit_to_params planarity pickle5 molecular_rectifier mrcfile dirsync && conda install -c conda-forge glew glm planarity openbabel lbzip2 --yes &&
conda install -c anaconda netcdf4 --yes && conda install -c conda-forge mesalib &&
